...
#from .context_manager_activate import ContextManager
from .context_manager_activate_3_activated_query_analyse import ContextManager

import json
attention_num = 0
def actqkv_activate_forward(
    n_local, n_init, topk, 
