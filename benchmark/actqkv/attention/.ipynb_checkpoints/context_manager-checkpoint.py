...
class ContextManager:
    def __init__(self, 
        ...
        #self.question_ids = [self.n_init,self.n_init+self.block_size]
        self.question_weight = question_weight
        print("question_ids",self.question_ids)
    ...
    def append(
        ...
        # with open(f'../LLLM/visualization/llama3-repr4-l512-bs64-topk8-w4/exp_score_lllm.jsonl', 'a') as f:
        #     json.dump({'attention_num': attention_num % 32, 'block_score': block_score, 'block_k': block_k, 'chunk_num': attention_num // 32 }, f)
        #     f.write('\n')
