...
class VectorTensor:
    ...
    def get_topk(self, tensor: torch.Tensor, avctivated_weight:torch.Tensor, topk):  # inner product
        ...
        data_to_save = {
            ...
            'normalized_scores': normalized_scores.cpu().tolist(),
        ...
        if  inference_step > layer_num:
            ...
            file_name = f'./result/analyse/dynamic_topk_analyse.json'
        ...
        if not self._use_chunk_topk:
            ...
            for u in range(self.num_units):
                ...
                topk, score= self.block_k[u].get_topk(
                    global_h_q[u], dev_, self.topk if self.topk < self.num_global_block else self.num_global_block)
