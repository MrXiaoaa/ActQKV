...
#from .context_manager_activate_3_original_query_analyse import ContextManager
from .context_manager_activate_3_dev import ContextManager

import json
attention_num = 0
def actqkv_dev_forward(
    n_local, n_init, topk, 
    ...
    *args, **kwargs
    ...
    def forward(self, query : torch.Tensor,
        ...
        # # 根据layer_idx为不同层设置不同参数
        # if layer_idx < 10:
        #     n_local = 5
        #     max_cached_block = 50
        # else:
        #     n_local = 10
        #     max_cached_block = 100
        ...
        # with open(f'./result/score/actqkv.jsonl', 'a') as f:
        #     json.dump({'attention_num': attention_num % 32, 'chunk_num': attention_num // 32 ,'past_key_value_shape': past_key_value.size() }, f)
        #     f.write('\n')
